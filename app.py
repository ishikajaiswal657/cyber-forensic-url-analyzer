...
from csv_logger import log_scan
...
def check_url_endpoint():
    ...
    try:
        ...
        log_scan("url", url_to_scan, raw_result.get("domain"), raw_result.get("score"), raw_result.get("verdict"))
...
def assess_url_endpoint():
    ...
    try:
        ...
        log_scan("url", url_to_scan, raw_result.get("domain"), raw_result.get("agent_score"), raw_result.get("verdict"))
        result = json_serializable(raw_result)
        return jsonify(result)
...
def check_email_endpoint():
    ...
    try:
        ...
        log_scan("email", raw_result.get("subject", "unknown"), raw_result.get("from_domain"), raw_result.get("score"), raw_result.get("verdict"))
        # Serialize datetime objects recursively
        result = json_serializable(raw_result)
        return jsonify(result)
...
def assess_email_endpoint():
    ...
    try:
        ...
        log_scan("email", raw_result.get("subject", "unknown"), raw_result.get("domain"), raw_result.get("agent_score"), raw_result.get("verdict"))
        result = json_serializable(raw_result)
        return jsonify(result)
